...
class ObjectLevel1Equatable20 extends Equatable {
  final int intVal;
  ...
  factory ObjectLevel1Equatable20.createFromRandom(RandomValues randomValues) =>
      ObjectLevel1Equatable20(
  ...
  ObjectLevel1Equatable20 copyWith({
    int? intVal,
    String? stringVal,
    double? doubleVal,
    num? numVal,
    ...
    return ObjectLevel1Equatable20(
